...
<html  ng-app="YuktixApp">
    <head>
        <title> Lake stage area relationship page </title>
                    ...
                    <div class="row row-padding">
                        ...
                        <div  class="col-md-6" id ="content">
                            ...
                            <form name="csvUploadForm" >
                                ...
                                <p>
                                Please upload the lake stage area relationship data
                                as comma separated values file (.csv). 
                                First column is stage in meters and second column is area in square meters.
                            ...
                            <div class="file-download-container" ng-show="display.downloadLink">
                                <h6>System stage area relationship file</h6>
                            ...
                            <div ng-show="!display.downloadLink">
                                <h6>No stage area relationship file in the system </h6>
                            </div>
        ...
        yuktixApp.controller("yuktix.admin.lake.csv.upload", function ($scope, lake, fupload,$window) {
            ...
            $scope.send_file_data = function(fileId) {
                ...
                lake.storeRelationshipFile($scope.base, $scope.debug,$scope.lakeId, $scope.fileCode, fileId).then(function (response) {
                        ...
                        var message = "stage area relationship file uploaded!" 
            ...
            // sample stage-area data 
            $scope.samples = [] ;
            
            $scope.samples.push("0.15 , 17563.75586");
            $scope.samples.push("0.65 , 88606.63559");
            $scope.samples.push("1.15 , 190152.1327");
