                        ...
                        <form name="InletForm">
                            <div class="mdl-grid">
                                <div class="mdl-cell mdl-cell--10-col">
                                    <h5>Sensor-Stage-Flow Details</h5>
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="s_no">
                                        <label class="mdl-textfield__label" for="sample3">Serial Number...</label>
                                    </div>

                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="custom-date-box" value="">
                                        <label class="mdl-textfield__label" for="custom-date-box">Installation Date...</label>
                                    </div>
                                    
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="inst_by">
                                        <label class="mdl-textfield__label" for="sample3">Installed By...</label>
                                    </div>
                                    
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                        <input class="mdl-textfield__input" type="text" id="p_no">
                                        <label class="mdl-textfield__label" for="sample3">Part Number...</label>
                                    </div>

                                    <h5>SensorStage-Flow</h5>
...
<script>
    ...
    $( function() {
        var date=$("#custom-date-box").datepicker({ dateFormat: 'dd-mm-yy' });
        document.getElementById("custom-date-box").value = date;
    } );
